...
LadiPageScriptV2.prototype.init = function() {
    this.const = {
        ...
        STATIC_VIDEO_DOMAIN: "s.ladicdn.com",
        ...
        SETTING_PRODUCT_VARIANT_TYPE: {
            combined: "combined",
            combobox: "combobox"
        },
        SETTING_PRODUCT_VARIANT_TITLE: {
            left: "left",
            top: "top"
        },
        FORM_THANKYOU_TYPE: {
        ...
        LANG: {
            ...
            ADD_TO_CART_NO_QUANTITY: "Sáº£n pháº©m Ä‘Ã£ háº¿t sá»‘ lÆ°á»£ng!",
            ADD_TO_CART_QUANTITY_REQUIRED: "Vui lÃ²ng nháº­p sá»‘ lÆ°á»£ng!",
            ADD_TO_CART_NO_PRODUCT: "KhÃ´ng tÃ¬m tháº¥y thÃ´ng tin sáº£n pháº©m, vui lÃ²ng thá»­ láº¡i sau!"
        }
    }, this.runtime = {
    ...
    var u, p = function(t, i, a, n) {
            if (t = t || document.getElementById(i), !e.isEmpty(t))
                if (e.isEmpty(n)) t.addEventListener("click", function(t) {
                    ...
                    if (n.type == e.const.DATA_ACTION_TYPE.link && t.addEventListener("click", function(a) {
                            ...
                            "true" != t.getAttribute("data-action") || e.isEmpty(n.action) || e.createTmpElement("a", "", {
                        ...
                        if (!e.isEmpty(o)) {
                            ...
                            if (!e.isEmpty(l)) {
                                ...
                                if (!e.isEmpty(s) && !e.isEmpty(c)) {
                                    var d = e.generateVariantProduct(s, !0, c, l["option.input_setting_product_variant_type"], l["option.input_setting_product_variant_title"], l["option.input_setting_product_variant_price"], l["option.input_tabindex"], t, !0, function(t) {
                                        f(i, a)
                                    });
                                    if (!e.isEmpty(d)) {
            ...
            if (!(e.isEmpty(n) || e.isEmpty(n["option.setting_product"]) || e.isEmpty(n["option.setting_product_key"]))) {
                ...
                if (!e.isEmpty(r)) {
                    var o = JSON.stringify(n),
                        l = e.generateProductKey(o, !0, n["option.setting_product"], r, n["option.setting_product_key"], !1, function(t) {
                            h(i, a)
                        });
                    if (o !== l) {
                        var s = null,
                        ...
                        if ("gallery" == a) {
                            ...
                            for (var g = s.getElementsByClassName("ladi-gallery-control-item"), _ = function(t) {
                                    y(t, i, s)
                                }; g.length < l.length;) {
                                var f = e.createTmpElement("div", '<div class="ladi-gallery-control-item" data-index="' + g.length + '"></div>', null, !0);
                                f.addEventListener("click", _), s.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(f)
                            }
                            for (; g.length > l.length;) g[g.length - 1].parentElement.removeChild(g[g.length - 1]);
                            ...
                            l.forEach(function(a, n) {
                                d = e.getOptimizeImage(a.src, E.clientWidth, E.clientHeight, !0, !1, !1, t), v += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + d + '");}', d = e.getOptimizeImage(a.src, L.clientWidth, L.clientHeight, !0, !1, !1, t), v += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + d + '");}'
                            }), s.setAttribute("data-max-item", l.length), e.isEmpty(v) || e.createStyleElement(c, v)
                        }
                    }
                }
            }
    ...
    this.runtime.tmp.generateLadiSaleProduct = function(t) {
                                            ...
                                            if (-1 != p)
                                                for (var g = 0; g < m.length; g++)
                                                    if (m[g].id != o.id) {
                                                        ...
                                                        if (!e.isEmpty(y)) {
                                                            var _ = null;
                                                            if (y["option.input_setting_product_variant_type"] == e.const.SETTING_PRODUCT_VARIANT_TYPE.combobox) {
                                                                if (!e.isArray(u.product.variants)) continue;
                                                                for (var f = u.product.variants[p], h = f.option_ids.split("/"), v = 0; v < h.length; v++) _ = document.querySelector("#" + m[g].id + ' .ladi-form-item [data-product-variant-id="' + h[v] + '"]'), e.isEmpty(_) || _.getAttribute("data-store-id") != u.store_info.id || _.getAttribute("data-product-id") != f.product_id || (_.value = f["option" + (v + 1)])
                                                            }
                                                            if (y["option.input_setting_product_variant_type"] == e.const.SETTING_PRODUCT_VARIANT_TYPE.combined) {
                                                                if (_ = m[g].querySelector("select.ladi-form-control"), e.isEmpty(_) || _.getAttribute("data-store-id") != u.store_info.id || _.getAttribute("data-product-id") != u.product.product_id) continue;
                                                                _.value = p + ""
                                                            }
                                                        }
                                                ...
                                                if (!e.isEmpty(L)) {
                                                    var P = L.querySelector('input[name="quantity"]');
                                                    e.isEmpty(P) || P.dispatchEvent(new Event("input"))
                                                }
                                            }
                                            i()
                                        }
            ...
            e.isEmpty(n) ? (function(t, i, a, n) {
            ...
            }(i, a.type, a["option.background_video.video_type"], a["option.background_video.video_value"]), p(null, i, a.type, a["option.data_action"]), function(t, i, a, n, r, o, l) {
                    ...
                    if (!e.isEmpty(r)) {
                        ...
                        if (e.isEmpty(o)) {
                            if (s) {
                                ...
                                var c = (parseFloatLadiPage(n) || 0) + 50;
                ...
                if ("gallery" == i) {
                    ...
                    if (!e.isEmpty(a)) {
                        ...
                        var r = function(e) {
                                e.stopPropagation(), g(t, e.target, !1)
                            },
                            o = document.querySelectorAll("#" + t + " > .preload").length > 0;
                        if (n > 0) {
                            for (var l = 0; l < n; l++) {
                                var s = a.getElementsByClassName("ladi-gallery-view-item")[l];
                                e.isEmpty(s) || (o && g(t, s, o), s.classList.contains("play-video") && s.addEventListener("click", r))
                            }
                            if (n <= 1)
                                for (var c = a.getElementsByClassName("ladi-gallery-view-arrow"), d = 0; d < c.length; d++) c[d].classList.add("ladi-hidden");
                            a.setAttribute("data-current", 0), a.setAttribute("data-is-next", !0)
                        }
                    }
                }
            }(i, a.type), e.startAutoScroll(i, a.type, a[e.const.DESKTOP + ".option.auto_scroll"], a[e.const.MOBILE + ".option.auto_scroll"]), f(i, a.type), function(t, i) {
                if ("form" == i) {
                                ...
                                var o = a["option.ladisale_store_id"],
                                    l = function(i) {
                                        if (!e.isEmpty(i.target.value)) {
                                            var n = e.generateVariantProduct(a["option.setting_product"], !1, o, null, null, null, null, !0, !0, function() {
                                                l(i)
                                            });
        ...
        function() {
            if (e.runtime.isClient && !e.runtime.isDesktop && !e.isEmpty(e.runtime.bodyFontSize)) {
                var t = (parseFloatLadiPage(getComputedStyle(document.body).fontSize) || 0) / e.runtime.bodyFontSize;
                if (1 != t)
                    for (var i = document.querySelectorAll(".ladi-paragraph, .ladi-list-paragraph, .ladi-headline, .ladi-countdown, .ladi-form"), a = 0; a < i.length; a++) {
                        var n = (parseFloatLadiPage(getComputedStyle(i[a]).fontSize) || 0) / (t * t);
        ...
        function() {
            var i, a = document.getElementsByClassName("ladi-form"),
                ...
                p = null,
                m = null,
                g = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"],
                y = ["name", "email", "phone", "address", "ward", "district", "state", "country"],
                _ = ["email", "phone"],
                ...
                h = function(t, i, a) {
                    ...
                    if (u.forEach(function(t) {
                            e.isEmpty(o[t]) && n.push(t)
                        }), i && (n = n.only([a])), n.length > 0) return i || e.showMessage(e.const.LANG.FORM_INPUT_REQUIRED_ERROR, null, function() {
                    ...
                    for (l = 0; l < p.length; l++)
                        if (!i || p[l].name == a) {
                            var c = o[p[l].name];
                            if (!e.isEmpty(c)) try {
                                if (!new RegExp("^" + p[l].pattern + "$", p[l].pattern_flag).test(c)) {
                                    i || e.showMessage(p[l].title, null, s), r = !1;
                                    break
                                }
                            } catch (t) {}
                        } return r
                ...
                v = function(t, i) {
                    ...
                    var m = Object.keys(r).sort(function(t, e) {
                        return r[t] - r[e]
                    });
                    if (m.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length)
                        for (var g = 0; g < m.length; g++) {
                            var _ = e.runtime.list_set_value_name_country.indexOf(m[g]); - 1 != _ && (m[g] = f[_])
                        }
                    ...
                    for (var v = 0; v < a.length; v++) {
                        if (c = a[v].getAttribute("name"), a[v].required && -1 == u.indexOf(c) && u.push(c), "INPUT" == a[v].tagName) {
                            ...
                            if ("email" == E ? p.push({
                                    ...
                                    name: c,
                                    pattern: L,
                                    title: e.isEmpty(P) ? e.const.LANG.FORM_INPUT_TEXT_REGEX : P
                                }), "checkbox" == E) {
                                e.isArray(o[c]) || (o[c] = []), a[v].checked && o[c].push(a[v].value);
                                continue
                            }
                            if ("radio" == E) {
                                a[v].checked && (o[c] = a[v].value);
                                continue
                            }
                        }
                        o[c] = a[v].value
                    }
                    i || y.forEach(function(t) {
                        e.isNull(o[t]) || (e.setCookie(window.location.host, "_ladipage_" + t, o[t], 365), e.isArray(e.runtime.DOMAIN_SET_COOKIE) && e.runtime.DOMAIN_SET_COOKIE.forEach(function(i) {
                            i != window.location.host && e.setCookie(i, "_ladipage_" + t, o[t], 365)
                        }))
                    }), l = n(o)
                },
                E = function(t, i, a) {
                    ...
                    s.forEach(function(t) {
                        var i = o[t];
                        e.isArray(i) && 0 == i.length && (i = ""), i = -1 != l.indexOf(t) ? LadiFormApi[t] : i, n.form_data.push({
                            name: t,
                            value: i
                        })
                    }), (l = l.except(s)).forEach(function(t) {
                        n.form_data.push({
                            name: t,
                            value: LadiFormApi[t]
                        })
                    }), n.tracking_form.push({
                        name: "url_page",
                        value: window.location.href
                    }), g.forEach(function(t) {
                        var i = m[t];
                        i = e.isNull(i) ? "" : i, n.tracking_form.push({
                            name: t,
                            value: i
                        })
                    }), e.isFunction(a) && a(n)
                ...
                P = function(t) {
                    v(t, !1), h(t, !1, null) && (E(!1, null, function(t) {
                        e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                            "Content-Type": "application/json"
                        })
                    }), e.showMessage(e.const.LANG.FORM_SEND_DATA_NO_CONFIG), L(t))
                },
                S = function(i, a, n, r) {
                    ...
                    if (!e.isEmpty(y)) {
                        ...
                        if (a) {
                            ...
                            if (v(y, a), !h(y, a, r)) return;
                            E(a, n, function(t) {
                                var i = t.form_data.findIndex(function(t) {
                                        return t.name == r
                                    }),
                                    a = -1 != i ? t.form_data[i].value : null;
                                !e.isEmpty(e.runtime.tmp.capture_form_data_last[n + "_" + r]) && e.equals(e.runtime.tmp.capture_form_data_last[n + "_" + r], a) || (e.runtime.tmp.capture_form_data_last[n + "_" + r] = a, e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                                    "Content-Type": "application/json"
                                }))
                            })
                        } else if (e.isEmpty(_)) P(y);
                            ...
                            var f = _["option.form_send_ladipage"],
                                S = _["option.form_api_data"],
                                A = _["option.thankyou_type"],
                                b = _["option.thankyou_value"];
                            if (e.isEmpty(c)) P(y);
                            else if (v(y, a), h(y, a, r)) {
                                var w = 0,
                                    T = 0,
                                    C = [],
                                    N = !1,
                                    ...
                                    I = !0,
                                    O = function(t) {
                                        t && L(y), delete e.runtime.tmp.form_sending[i.id], y.querySelector(".ladi-button > .ladi-element > .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                                    },
                                    k = function() {
                                        var a, n, r, s;
                                        e.deleteCookie("_capture_" + i.id), e.deleteCookie("_cart_token"), e.deleteCookie("_checkout_token"), e.createCartData(), a = function() {
                                            ...
                                            A == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(b) || e.showMessage(b, l)), A == e.const.FORM_THANKYOU_TYPE.popup && (r && e.setDataReplaceElement(!1, !1, l, b), window.ladi(b).show()), A == e.const.FORM_THANKYOU_TYPE.url && (e.isEmpty(b) || window.ladi(b).open_url("_top", r ? o : null))
                                        }, n = null, r = !1, s = function() {
                                            r || (e.isFunction(a) && a(), e.removeTimeout(n), r = !0)
                                        }, e.isEmpty(d[e.const.TRACKING_NAME]) ? s() : (n = e.runTimeout(s, 3e3), e.sendRequest("POST", e.const.API_CHECKING_FORM, JSON.stringify(d), !0, {
                                            "Content-Type": "application/json"
                                        }, function(t, e, i) {
                                            i.readyState == XMLHttpRequest.DONE && s()
                                        }))
                                    },
                                    D = function(t, a, n, r) {
                                        if (n.readyState == XMLHttpRequest.DONE) {
                                            if (r == e.const.API_FORM_DATA) {
                                                ...
                                                200 == o.code ? w++ : (T++, I = !1)
                                            } else 200 == a || 201 == a ? w++ : e.getElementAHref(r).host == e.const.DOMAIN_GOOGLE_DOCS ? w++ : T++;
                                            w + T == C.length && (I && !N && w >= 1 ? (N = !0, e.runEventTracking(i.id, !0), k(), O(!0)) : !x && T >= 1 && (x = !0, e.showMessage(e.const.LANG.FORM_SEND_DATA_ERROR), O(!1)))
                                        }
                                    },
                                    R = function(t) {
                                        C.push({
                                ...
                                f && E(a, n, R), e.isArray(S) && S.forEach(function(t) {
                                    if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields)) {
                                        ...
                                        i || (a.link = window.location.href, Object.keys(LadiFormApi).forEach(function(t) {
                                            a[t] = LadiFormApi[t]
                                        }), g.forEach(function(t) {
                                            var i = m[t];
                                            e.isNull(i) || (a[t] = i)
                                        ...
                                        s == e.const.CONTENT_TYPE.form_urlencoded && (n["Content-Type"] = "application/x-www-form-urlencoded", o = Object.keys(a).reduce(function(t, e) {
                                            return t.push(e + "=" + encodeURIComponent(a[e])), t
                                        }, []).join("&")), s == e.const.CONTENT_TYPE.json && (n["Content-Type"] = "application/json", o = JSON.stringify(a)), s == e.const.CONTENT_TYPE.form_data && (o = new FormData, Object.keys(a).forEach(function(t) {
                                            o.append(t, a[t])
                                        })), C.push({
                                            url: t.api_url,
                                            data: o,
                                ...
                                C.length > 0 ? B() : f ? P(y) : (B(), E(a, n, R)), C.forEach(function(t) {
                    ...
                    if (!e.isEmpty(i)) {
                        for (var a = i.querySelectorAll('[ladi-checkbox-required="true"]'), n = -1, r = 0; r < a.length; r++)
                            ...
                            if (o.length > 0) {
                                ...
                                for (var l = 0; l < o.length; l++) o[l].removeEventListener("change", A), o[l].addEventListener("change", A);
                                    ...
                                    var o = function() {
                                        ...
                                        if (e.isEmpty(t) || e.isEmpty(t.store_info) || e.isEmpty(t.product)) e.isEmpty(e.runtime.tmp.timeout_product_info[r][n["option.setting_product"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT);
                                            ...
                                            if (-1 != i) {
                                                ...
                                                var g = e.runtime.tmp.cart.findIndex(function(t) {
                                                    return t.product_variant_id == s
                                                }); - 1 == g && (e.runtime.tmp.cart.push({
                                                ...
                                                }), g = e.runtime.tmp.cart.length - 1);
                                                var y = a.querySelector('input[name="quantity"]');
                                                if (e.isEmpty(y) || e.isEmpty(y.value)) e.showMessage(e.const.LANG.ADD_TO_CART_QUANTITY_REQUIRED);
                                                else {
                                                    var _ = parseInt(y.value) || 0;
                                                    if (1 == t.product.variants[i].inventory_checked && e.runtime.tmp.cart[g].quantity + _ > p && (_ = p - e.runtime.tmp.cart[g].quantity), _ > 0) {
                                                        var f = function() {
                                                            e.runtime.tmp.cart[g].quantity += _, e.addCartCookie(t.store_info.id, {
                                                                type: "LP",
                                                                product_variant_id: s,
                                                                quantity: _
                                                            }, null, function() {
                                                                e.runtime.tmp.cart[g].quantity -= _
                                                            }, function() {
                                                                e.runtime.tmp.generateCart(), e.changeTotalPriceCart(), e.runtime.tmp.is_click_add_to_cart = !1, e.runResizeAll()
                                                            })
                                                        };
                    ...
                    if (!e.isEmpty(i)) {
                        ...
                        if (!e.isEmpty(a)) {
                            ...
                            if (!e.isEmpty(n) && n["option.form_auto_capture"] && !e.isEmpty(n["option.form_config_id"])) {
                                ...
                                e.isEmpty(r) && (r = n["option.form_config_id"] + "|" + e.runtime.ladipage_id + "|" + Date.now() + "|" + e.randomId(), e.setCookie(null, "_capture_" + a.id, r, 3e5 / 864e5, !1, window.location.pathname)), S(a, !0, r, t.target.getAttribute("name"))
                            }
                        }
                    }
                },
            ...
            y.forEach(function(t) {
                N[t] = e.getCookie("_ladipage_" + t), e.isEmpty(r[t]) || (N[t] = r[t])
            }), i = n(N);
            var x = 0,
                I = !1,
                O = function(t) {
            ...
            for (x = 0; x < a.length; x++) {
                ...
                for (var k = e.findAncestor(a[x], "ladi-element"), D = a[x].getElementsByClassName("ladi-button"), R = 0; R < D.length; R++) {
                    ...
                    if (!e.isEmpty(B)) {
                        ...
                        e.isEmpty(k) || e.isEmpty(e.runtime.eventData[k.id]) || !e.runtime.eventData[k.id]["option.is_add_to_cart"] ? M.addEventListener("click", T) : M.addEventListener("click", w)
                    }
                }
                for (var V = a[x].querySelectorAll("[tabindex]"), F = 0, q = 0; q < V.length; q++) {
                    var Y = parseInt(V[q].getAttribute("tabindex")) || 0;
                    Y > F && (F = Y), V[q].setAttribute("tabindex", e.runtime.tabindexForm + Y)
                }
                e.runtime.tabindexForm += F;
                for (var H = 0; H < _.length; H++) {
                    var U = a[x].querySelector('.ladi-element .ladi-form-item-container input[name="' + _[H] + '"]');
                    e.isEmpty(U) || U.addEventListener("focusout", C)
                }
            }
            var j = function(t, i) {
                for (I = i, x = 0; x < a.length; x++) {
                    var n = e.findAncestor(a[x], "ladi-element");
                    !e.isEmpty(e.runtime.eventData[n.id]) && e.runtime.eventData[n.id]["option.form_auto_complete"] && t.forEach(O)
                }
            };
            j(e.copy(y).except(e.runtime.list_set_value_name_country));
            ...
            if ("gallery" == i.type) {
                ...
                if (!e.isEmpty(a)) {
                    ...
                    a.getElementsByClassName("ladi-gallery-view-arrow-left")[0].addEventListener("click", function(e) {
                        e.stopPropagation(), a.setAttribute("data-is-next", !1), a.setAttribute("data-next-time", Date.now() + 1e3 * o), m(t, !1)
                    }), a.getElementsByClassName("ladi-gallery-view-arrow-right")[0].addEventListener("click", function(e) {
                        e.stopPropagation(), a.setAttribute("data-is-next", !0), a.setAttribute("data-next-time", Date.now() + 1e3 * o), m(t, !1)
                    ...
                    if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled")) {
                        ...
                        if (n && !e.isEmpty(r) && (o = r), o > 0) {
                            var l = a.getAttribute("data-next-time"),
                                s = Date.now();
                            e.isEmpty(l) && (l = s + 1e3 * (o - 1), a.setAttribute("data-next-time", l)), s >= l && (m(t, !0), a.setAttribute("data-next-time", s + 1e3 * o))
                        }
                    }
                }
            })
            ...
            if ("carousel" == i.type) {
                ...
                if (!e.isEmpty(a)) {
                    ...
                    a.getElementsByClassName("ladi-carousel-arrow-left")[0].addEventListener("click", function(e) {
                        e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !1), a.setAttribute("data-next-time", Date.now() + 1e3 * o), _(t, !1)
                    }), a.getElementsByClassName("ladi-carousel-arrow-right")[0].addEventListener("click", function(e) {
                        e.stopPropagation(), a.getElementsByClassName("ladi-carousel-content")[0].style.removeProperty("transition-duration"), a.setAttribute("data-is-next", !0), a.setAttribute("data-next-time", Date.now() + 1e3 * o), _(t, !1)
        ...
        function() {
            ...
            for (var n = document.querySelectorAll(".ladi-checkout .ladi-form-item input.ladi-form-control"), r = ["email", "coupon"], o = function(t) {
                ...
                }, l = 0; l < n.length; l++) - 1 != r.indexOf(n[l].getAttribute("name")) && n[l].addEventListener("change", o)
        }(),
        function() {
            c.forEach(function(t) {
                var i = e.runtime.eventData[t];
        ...
        function() {
            if (t) {
                ...
                if (n.forEach(function(t) {
                    ...
                    e.isEmpty(d[e.const.TRACKING_NAME]) || (l[e.const.TRACKING_NAME] = d[e.const.TRACKING_NAME]), e.sendRequest("POST", e.const.API_CHECK_VERIFY, JSON.stringify(l), !0, {
                        "Content-Type": "application/json"
                    }, function(t, a, n) {
                        n.readyState == XMLHttpRequest.DONE && 200 == a && 0 == JSON.parse(t).data && e.runTimeout(i, 3e3)
                    })
                }
            }
    ...
    if (!this.isEmpty(t) && (E = parseFloatLadiPage(getComputedStyle(t).height) || 0) != y && (!c || y > E)) {
        if (t.classList.contains("ladi-section")) y += i;
        else {
                ...
                _ = function() {
                    try {
                        if (c.runtime.isLoadYouTubeIframeAPI || (c.runtime.isLoadYouTubeIframeAPI = !0, window.onYouTubeIframeAPIReady = function() {
                            ...
                            }, c.loadScript("//www.youtube.com/iframe_api")), !c.runtime.isYouTubeIframeAPIReady) return void c.runtime.list_youtube_ready_exec.push(_);
                        d.outerHTML = d.outerHTML.replaceAll("<iframe", "<div").replaceAll("</iframe>", "</div>"), d = document.getElementById(t);
                        var e = !0;
                        ...
                        var i = function() {
                            ...
                            p = function(e) {
                                ...
                                c.isEmpty(i) ? c.runTimeout(p, 100) : (c.runResizeAll(), a ? i.mute() : i.unMute(), o || l || i.playVideo(), c.isFunction(s) && s())
                            };
                        new window.YT.Player(t, {
                            ...
                            events: {
                                ...
                                onStateChange: function(a) {
                                    if (e && a.data == window.YT.PlayerState.PLAYING) {
                                        e = !1;
                                        var r = function() {
                                            window.YT.get(t).getCurrentTime() >= .1 ? i() : c.runTimeout(r, 100)
                                        };
                                        n && r()
                                    }
                                    a.data == window.YT.PlayerState.ENDED && window.YT.get(t).playVideo()
                                },
                                onError: u
                            }
                        })
    ...
    var l = t.split("/"),
        s = l.indexOf("");
    if (-1 != s && l.length > s + 1 && (l[s + 1] = l[s + 1].toLowerCase()), s = l.indexOf(this.const.STATIC_DOMAIN.toLowerCase()), this.checkResizeImage(t) && -1 != s && (l.length == s + 3 || l.length == s + 6 && "ls" == l[3] && "product" == l[5] || l.length == s + 4 && "luid" == l[3] && "avatar" == l[4] || l.length == s + 4 && "rbg" == l[4])) {
    ...
    try {
        t.isFunction(window.ladi_viewport) && window.ladi_viewport(), t.runtime.tmp.generateAddToCart(), t.runtime.tmp.generateCart(), Object.keys(t.runtime.eventData).forEach(function(e) {
            t.loadCollectionData(e, null, null, !1, !0)
        });
    ...
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript), !e.isEmpty(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
        ...
        if (Object.keys(e.runtime.eventData).forEach(function(t) {
                ...
                if (-1 != Object.keys(e.runtime.list_scroll_func).indexOf(t) && (n = document.getElementById(t), !e.isEmpty(n))) {
                    var o = !1;
                    "section" == a.type ? (r = n.offsetTop, (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (o = !0)) : (r = e.getElementBoundingClientRect(n).y + window.scrollY, (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= r && window.scrollY + e.getHeightDevice(!0) <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= r) && (o = !0)), o && ((0, e.runtime.list_scroll_func[t])(), delete e.runtime.list_scroll_func[t])
                }
                var l = a[e.runtime.device + ".style.animation-name"];
                if (!e.isEmpty(l) && (n = document.getElementById(t), !e.isEmpty(n) && !n.classList.contains("ladi-animation"))) {
                    var s = parseFloatLadiPage(a[e.runtime.device + ".style.animation-delay"]) || 0;
                    r = e.getElementBoundingClientRect(n).y + window.scrollY;
                    var c = window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= r && window.scrollY + e.getHeightDevice(!0) <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= r;
                    e.runtime.tmp.isFirstScroll && s > 0 && !c && n.classList.add("ladi-animation-hidden"), c && (n.classList.add("ladi-animation"), e.runTimeout(function() {
                ...
                var d = null,
                    u = null,
                    p = null;
                if (a[e.runtime.device + ".option.sticky"] && (d = a[e.runtime.device + ".option.sticky_position"], u = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"]), p = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"])), !e.isEmpty(d)) {
                    var m = document.getElementById(t);
                    if (!e.isEmpty(m) && -1 != ["default", "top", "bottom"].indexOf(d)) {
                        var g = e.getElementBoundingClientRect(m),
                            y = m.getAttribute("data-top"),
                            _ = m.getAttribute("data-left");
                        e.isEmpty(y) ? (m.setAttribute("data-top", g.y + window.scrollY), y = g.y) : y = parseFloatLadiPage(y), e.isEmpty(_) ? (m.setAttribute("data-left", g.x + window.scrollX), _ = g.x) : _ = parseFloatLadiPage(_);
                        var f = null,
                            h = null;
                        if ("default" == d && (u > y - window.scrollY ? (f = u + "px", h = _ + "px") : e.getHeightDevice() - p - m.clientHeight < y - window.scrollY && (f = "calc(100% - " + (p + m.clientHeight) + "px)", h = _ + "px")), "top" == d && (u > y - window.scrollY || e.getHeightDevice() - 0 < y - window.scrollY) && (f = u + "px", h = _ + "px"), "bottom" == d && (e.getHeightDevice() - p - m.clientHeight < y - window.scrollY || 0 > y + m.clientHeight - window.scrollY) && (f = "calc(100% - " + (p + m.clientHeight) + "px)", h = _ + "px"), e.isEmpty(f) || e.isEmpty(h)) m.style.removeProperty("top"), m.style.removeProperty("left"), m.style.removeProperty("width"), m.style.removeProperty("position"), m.style.removeProperty("z-index");
                        else if (m.style.setProperty("top", f), m.style.setProperty("left", h), "section" == a.type && (e.runtime.isMobileOnly ? m.style.setProperty("width", document.getElementsByClassName("ladi-wraper")[0].clientWidth + "px") : i && m.style.setProperty("width", "100%")), m.style.setProperty("position", "fixed"), m.style.setProperty("z-index", "90000050"), !m.hasAttribute("data-first")) {
                            m.setAttribute("data-first", !0), m.classList.contains("ladi-animation-hidden") && (m.classList.remove("ladi-animation-hidden"), m.classList.add("ladi-animation"));
                            for (var v = m.getElementsByClassName("ladi-animation-hidden"); v.length > 0;) v[0].classList.add("ladi-animation"), v[0].classList.remove("ladi-animation-hidden");
                            m.classList.remove("ladi-lazyload");
                            for (var E = m.getElementsByClassName("ladi-lazyload"); E.length > 0;) E[0].classList.remove("ladi-lazyload")
                        }
                    }
                }
                if ("popup" == a.type) {
    ...
    if (!r.isEmpty(o) && "collection" == o.type) {
        var l = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE,
            ...
            d = function(t, e, i, a, n) {
                var o = JSON.stringify(e),
                    l = null;
                if (r.isEmpty(a) || o !== (l = r.generateProductKey(o, !0, a, i, n, !0, function(r) {
                        d(t, e, i, a, n)
                    }))) {
                    var s = null,
                        c = e.type,
            ...
            u = function(t) {
                ...
                if (!r.isEmpty(e)) {
                    ...
                    var p = parseFloatLadiPage(getComputedStyle(e).height) || 0,
                        m = i.scrollHeight;
                    if (o += "#" + t + " {height: " + m + "px;}", r.createStyleElement(a, o), p != m) {
                        var g = r.findAncestor(e, "ladi-element");
                        r.isEmpty(g) && (g = r.findAncestor(e, "ladi-section")), r.updateHeightElement(g, e, 50, 10, p, m, a, o, !0)
                    }
                }
            },
            p = function(t) {
            ...
            m = function(t, n, o) {
                var l = s * c,
                    g = r.getListProductByTagId(n, e, o, l, i, !0, function() {
                        m(t, n, o)
                    });
                if (r.isObject(g) && r.isArray(g.products)) {
                    var y = document.getElementById(t);
                    if (r.isEmpty(y)) return;
                    if (y.getAttribute("data-page") == i) return;
                    var _ = i,
                        f = !1;
                    if (!r.isEmpty(g.total_record) && i * l >= g.total_record) {
                        if (e == r.const.COLLECTION_TYPE.readmore) {
                            var h = y.getElementsByClassName("ladi-collection-button-next")[0];
                            r.isEmpty(h) || h.setAttribute("data-opacity", "0")
                        }
                        y.setAttribute("data-max-page", _), f = !0
                    }
                    if (y.setAttribute("data-page", i > _ ? _ : i), _ < i) return;
                    var v = y.getElementsByClassName("ladi-collection-item");
                    if (0 == v.length) return;
                    var E = y.getElementsByClassName("ladi-collection-content")[0],
                        L = {
                            className: v[0].className,
                            innerHTML: v[0].innerHTML
                        };
                    a && v[0].parentElement.removeChild(v[0]);
                    for (var P = E.getElementsByClassName("ladi-collection-page"); P.length < i;) {
                        var S = document.createElement("div");
                        S.className = "ladi-collection-page", E.appendChild(S)
                    }
                    var A = P[i - 1],
                        b = A.getElementsByClassName("ladi-collection-item");
                    if (b.length != g.products.length)
                        for (; b.length > 0;) b[0].parentElement.removeChild(b[0]);
                    for (var w = 0; w < g.products.length; w++)
                        if (!(b.length > w)) {
                            var T = document.createElement("div");
                            T.className = L.className, A.appendChild(T), T.innerHTML = L.innerHTML;
                            for (var C = T.getElementsByClassName("ladi-element"), N = 0; N < C.length; N++) {
                                var x = r.runtime.eventData[C[N].id];
                                r.isEmpty(x) || (r.isFunction(r.runtime.tmp.runOptionAction) && r.runtime.tmp.runOptionAction(C[N], C[N].id, x.type, x["option.data_action"]), r.isEmpty(x["option.setting_product_key"]) || d(C[N], x, n, g.products[w].product_id, x["option.setting_product_key"]))
                            }
                        } f && A.classList.add("last"), e == r.const.COLLECTION_TYPE.carousel && p(t), e == r.const.COLLECTION_TYPE.readmore && u(t), r.runResizeAll()
                }
            };
        ...
        var g = o["option.ladisale_store_id"],
            y = o["option.product_tag_id"];
        r.isArray(y) && m(t, g, y)
    }
        ...
        if (n.readyState == XMLHttpRequest.DONE) {
            if (200 == a) try {
                ...
                200 == r.code && r.data.items.forEach(function(e) {
                    ...
                    t.isEmpty(i) || (i = "https://" + t.const.STATIC_DOMAIN + "/" + i), -1 == t.runtime.tmp.cart.findIndex(function(t) {
    ...
    if (this.runtime.tmp.cart.length > 0 && !this.isEmpty(this.runtime.tmp.cart[0].currency) && !this.isEmpty(this.runtime.tmp.cart[0].currency.symbol)) {
        ...
        r = this.formatCurrency(r, c), o = this.formatCurrency(o, c), l = this.formatCurrency(l, c), s = this.formatCurrency(s, c)
    }
    ...
    var e = this.runtime.tmp.cart.findIndex(function(e) {
        ...
        i = this; - 1 != e && this.updateCartCookie({
        type: "LP",
    ...
    if (-1 != a) {
        ...
        this.updateCartCookie({
            ...
            n.isObject(n.runtime.tmp.cart[a].currency) && !n.isEmpty(n.runtime.tmp.cart[a].currency.symbol) && (i = n.formatCurrency(i, n.runtime.tmp.cart[a].currency.symbol));
    ...
    n = i ? a.runtime.tmp.cart : [{
        ...
        currency: {
            symbol: LadiPage.getRootScope().currency
        }
    }];
    var r = "";
    if (r += "<tbody>", 0 == n.length) r += '<tr><td class="ladi-cart-no-product">' + e + "</td></tr>";
        ...
        n.forEach(function(e) {
            ...
            var o = a.formatNumber(e.price * e.quantity, 3);
            a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (o = a.formatCurrency(o, e.currency.symbol)), r += o + "</span></td>", t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-action"><button onclick="javascript: LadiPageScript.removeAddToCartProduct(' + e.product_variant_id + ');" type="button"><span>X</span></button></td>', r += "</tr>")
        })
    }
    return r += "</tbody>"
    ...
    var l = this,
        s = l.generateVariantProduct(i, !1, a, null, null, null, null, !0, !0, function(e) {
            l.generateProductKey(t, !1, i, a, n, r, o)
        });
    if (l.isObject(s) && l.isObject(s.product)) {
        var c = null;
        if (-1 != ["name", "description"].indexOf(n) && (c = s.product[n], t = c), -1 != ["image"].indexOf(n) && (c = s.product[n], l.isObject(c) && (t = c.src, l.isEmpty(t) || (t = "https://" + l.const.STATIC_DOMAIN + "/" + t))), -1 != ["images"].indexOf(n) && (c = s.product[n], l.isArray(c) && (t = [], c.forEach(function(e) {
                l.isEmpty(e.src) || t.push({
                    src: "https://" + l.const.STATIC_DOMAIN + "/" + e.src
                })
            }))), l.isArray(s.product.variants) && s.product.variants.length > 0) {
            var d = r ? 0 : l.getProductVariantIndex(null, i, a);
            if (-1 != d) {
                var u = s.product.variants[d];
                if (-1 != ["title", "sku"].indexOf(n) && (c = u[n], t = c), -1 != ["text_quantity"].indexOf(n) && (c = 1 == u.inventory_checked ? u[n] : "", t = c), -1 != ["weight"].indexOf(n) && (c = u[n], l.isEmpty(u.weight_unit) || (c += u.weight_unit), t = c), -1 != ["price"].indexOf(n) && (c = l.formatNumber(u[n], 3), l.isObject(s.store_info) && l.isObject(s.store_info.currency) && !l.isEmpty(s.store_info.currency.symbol) && (c = l.formatCurrency(c, s.store_info.currency.symbol)), t = c), -1 != ["src"].indexOf(n)) {
                    if (c = u[n], l.isEmpty(c)) {
                        if ("src" == n) return l.generateProductKey(t, e, i, a, "image", !1, o)
                    } else c = "https://" + l.const.STATIC_DOMAIN + "/" + c;
                    t = c
                }
            }
        ...
        if (u.isNull(p)) {
            ...
            return u.sendRequest("POST", u.const.API_SHOW_PRODUCT, JSON.stringify(g), !0, {
                ...
                if (n.readyState == XMLHttpRequest.DONE) try {
                    ...
                    u.runtime.tmp.product_info[i][t] = !1, u.isEmpty(u.runtime.tmp.timeout_product_info[i][t]) || (u.removeTimeout(u.runtime.tmp.timeout_product_info[i][t]), delete u.runtime.tmp.timeout_product_info[i][t])
                }
            }), d
    ...
    if (l.isArray(i) && i.length > 0 && !l.isEmpty(t)) {
        ...
        var c = JSON.stringify(i) + "_page_" + n + "_limit_" + a,
            ...
            u = function() {
                var e = null;
                return l.isObject(d) && l.isArray(d.products) && (e = {
                    products: d.products,
                    total_record: d.total_record
                }, l.isEmpty(l.runtime.tmp.product_info[t]) && (l.runtime.tmp.product_info[t] = {}), e.products.forEach(function(e) {
                    l.runtime.tmp.product_info[t][e.product_id] = {
                        store_info: d.store_info,
                        product: e
                    }
                })), e
            };
        if (l.isNull(d)) {
            ...
            return l.isEmpty(e) ? p.type = "group" : p.paged = n, l.sendRequest("POST", l.const.API_COLLECTION_PRODUCT, JSON.stringify(p), !0, {
                "Content-Type": "application/json",
                "Store-Id": t
            }, function(e, i, a) {
                if (a.readyState == XMLHttpRequest.DONE) try {
                    ...
                    l.runtime.tmp.product_tag_info[t][c] = !1, l.isEmpty(l.runtime.tmp.timeout_product_tag_info[t][c]) || (l.removeTimeout(l.runtime.tmp.timeout_product_tag_info[t][c]), delete l.runtime.tmp.timeout_product_tag_info[t][c])
                }
            }), s
        }!0 === d ? l.runtime.tmp.timeout_product_tag_info[t][c] = l.runTimeout(function() {
            l.getListProductByTagId(t, e, i, a, n, !1, o)
        }, 100) : (s = u(), !r && l.isFunction(o) && o(s))
    }
    return s
}, LadiPageScriptV2.prototype.formatCurrency = function(t, e) {
    return t + " " + e
    ...
    for (var n = this, r = t, o = new RegExp(n.runtime.replacePrefixStart + "[^" + n.runtime.replacePrefixStart + "$" + n.runtime.replacePrefixEnd + "]*" + n.runtime.replacePrefixEnd, "gi"), l = null, s = [], c = function(t) {
            if (i) s.push(t);
                ...
                var e = t,
                    o = e.split("|");
                e = o[0].substr(n.runtime.replacePrefixStart.length), 1 == o.length && (e = e.substr(0, e.length - n.runtime.replacePrefixEnd.length));
                var l = n.getDataReplaceStr(e, a);
                if (n.isEmpty(l))
                    if (o.length > 1) {
                        var c = n.randomInt(1, o.length - 1);
                        l = o[c], c == o.length - 1 && (l = l.substr(0, l.length - n.runtime.replacePrefixEnd.length))
                    } else l = "";
                r = r.replaceAll(t, l)
            }
                ...
                if (!this.isNull(y) && ("country" != g || "true" != p[m].getAttribute("data-is-select-country"))) {
                    ...
                    if ("TEXTAREA" == p[m].tagName && (p[m].value = _.trim(), e && (p[m].innerHTML = p[m].value)), "SELECT" == p[m].tagName) {
                        ...
                        if (!this.isEmpty(P) && (p[m].value = P.getAttribute("value"), e && !P.hasAttribute("selected"))) {
                            for (var S = p[m].querySelectorAll("option"), A = 0; A < S.length; A++) S[A].removeAttribute("selected");
    ...
    lightbox_run = function(t, e, i, a, n, r, o, l) {
        ...
        if (!LadiPageScript.isEmpty(s)) {
            var c = JSON.stringify({
                ...
                d = Object.keys(LadiPageScript.runtime.list_lightbox_id); - 1 == d.indexOf(c) && (LadiPageScript.runtime.list_lightbox_id[c] = d.length + 1);
            ...
            var y = function() {
                    if (p = p = document.getElementById(n), !LadiPageScript.isEmpty(p)) {
                        if ("IFRAME" == p.tagName) {
                            ...
                            if (t > 0 || e > 0) {
                                var i = .9 * document.body.clientWidth,
                                    a = .9 * LadiPageScript.getHeightDevice(),
                                    r = i,
                                    o = e / t * r;
